...
This is a **learning project** and is about **having fun** implementing it. Everything here is a 
**coding adventure** inside this language. It is not meant to be public or to actually be usable. 
It will forever remain a toy language. It will stay **forever young** and unfinished. 
Just like the Axolotl, Axl's animal.
...
* *Readonly Bindings*: `let`
* *Target type propagation*: for native types
* *Arrays*
